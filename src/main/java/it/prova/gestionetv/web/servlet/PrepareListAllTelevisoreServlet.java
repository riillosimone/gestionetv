...
/**
 * Servlet implementation class PrepareListAllTelevisoreServlet
 */
@WebServlet("/PrepareListAllTelevisoreServlet")
public class PrepareListAllTelevisoreServlet extends HttpServlet {
